namespace L08_Canvas_Alley {
    ...
    let golden: number = 0.62; //goldener Schnitt (Variable)
    ...
    function handleLoad(_event: Event): void {
        ...
        drawMountains({ x: 0, y: crc2.canvas.height * golden }, 75, 200, "grey", "white");
        drawMountains({ x: 0, y: crc2.canvas.height * golden }, 50, 150, "grey", "lightgrey");
    }
