...
(function (Endabgabe) {
    class Food extends Endabgabe.Moveable {
        ...
        draw() {
            ...
            Endabgabe.crc2.beginPath();
            Endabgabe.crc2.save();
            Endabgabe.crc2.translate(this.position.x + 7, this.position.y + 5);
            // crc2.scale(this.size, this.size);
            Endabgabe.crc2.arc(0, 0, 5, 0, 2 * Math.PI);
            Endabgabe.crc2.fillStyle = "HSLA(20, 70%, 40%)";
            Endabgabe.crc2.fill();
            Endabgabe.crc2.restore();
            Endabgabe.crc2.closePath();
            Endabgabe.crc2.beginPath();
            Endabgabe.crc2.save();
            Endabgabe.crc2.translate(this.position.x - 5, this.position.y + 8);
            // crc2.scale(this.size, this.size);
            Endabgabe.crc2.arc(0, 0, 5, 0, 2 * Math.PI);
            Endabgabe.crc2.fillStyle = "HSLA(20, 80%, 30%)";
            Endabgabe.crc2.fill();
            Endabgabe.crc2.restore();
            Endabgabe.crc2.closePath();
        }
