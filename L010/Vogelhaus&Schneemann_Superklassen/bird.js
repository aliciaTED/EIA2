...
(function (L10_Canvas_Birdhouse) {
    class Bird {
        constructor() {
            ...
            this.velocity = new L10_Canvas_Birdhouse.Vector(-5, 0);
        }
        move(_timeslice) {
            //console.log("moved");
        ...
        drawFlyingBird() {
            ...
            let head = -15;
            L10_Canvas_Birdhouse.crc2.arc(head, -2, (1 / 2) * 15, 0, 2 * Math.PI);
            ...
            for (let drawn = 0; drawn < 20; drawn++) {
                ...
                // crc2.translate(x, y);
                L10_Canvas_Birdhouse.crc2.transform(scale, 0, 0, scale, 0, 0);
