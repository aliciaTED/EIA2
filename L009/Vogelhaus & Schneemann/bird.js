...
(function (L09_Canvas_Birdhouse) {
    class Bird {
        ...
        drawFlyingBird() {
            ...
            L09_Canvas_Birdhouse.crc2.arc(0, 0, radiusBird, 0, 2 * Math.PI);
            let head = 0 - radiusBird;
            L09_Canvas_Birdhouse.crc2.arc(head, -2, (1 / 2) * radiusBird, 0, 2 * Math.PI);
            L09_Canvas_Birdhouse.crc2.ellipse(5, -5, (1 / 3) * radiusBird, radiusBird, 13, 0, 2 * Math.PI);
